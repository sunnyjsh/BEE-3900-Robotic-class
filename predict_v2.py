...
def inverse_kinematics(x, y):
    ...
    The students need to implement a real inverse kinematics calculation to determine the conversion between x, y and angles. +
    ...
    angles = (np.random.rand(4) * 180).astype(int)
...
if __name__ == '__main__':
    video_path = "/home/pi/Desktop/output.mp4"
    port = "/dev/ttyACM0"
    baud_rate = 9600
